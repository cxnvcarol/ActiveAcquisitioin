...
public:
	...
	virtual void registerCameraObserver(ActiveCamera * cam)=0;
	virtual void loadProjectionSettings(const char* projectionsConfig)=0;//receives both formats: 3 fields per line, or the generated by the Texas DLP GUI: 7 fields per line
	virtual void playProjectionSequence(int n)=0;//plays the already loaded sequence

	virtual void notifyPlayToObservers()=0;
