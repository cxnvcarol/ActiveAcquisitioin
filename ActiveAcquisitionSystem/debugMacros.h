...
#define LOGEXEC(msg) printf("\n[%d]::", QDateTime::currentDateTime().time().msecsSinceStartOfDay());printf(msg);printf(" : %d\n", __LINE__)
//#define LOGERR(msg) printf("\n[%d]:ERROR!!!:: %s : %d\n", QDateTime::currentDateTime().time().msecsSinceStartOfDay(),(msg), __LINE__)
#define LOGERR(msg) printf("\n[%d]:ERROR!!!::", QDateTime::currentDateTime().time().msecsSinceStartOfDay());printf(msg);printf(" : %d\n", __LINE__)
/*
